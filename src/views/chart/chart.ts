        ...
        constructor(public route: ActivatedRoute) {
                ...
                this.options = {
                        chart: {
                                ...
                                x: function (d: any): string { return d.date; },
                                y: function (d: any): string { return d.close; },
                                duration: 100,
                                ...
                                xAxis: {
                                        ...
                                        tickFormat: function (d: number): string {
                                                let now = new Date();
                                                return d3.time.format('%x')(new Date((now as any) - (20000 * 86400000) + (d * 86400000)));
                                        },
                                        showMaxMin: false
                                },
                                ...
                                yAxis: {
                                        ...
                                        tickFormat: function (d: any): string {
